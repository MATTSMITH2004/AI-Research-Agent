...
**My take.** The thaw looks real, and the framework is the thing to watch, not the day-to-day quotes. One caution, flagged: GPT-5.5 Cyber's "beats Mythos" claim (85.6% vs 83.8% on the CyberGym benchmark) is OpenAI's own framing, landing while Mythos is forced offline and can't answer — not an independent head-to-head, so discount it accordingly.
